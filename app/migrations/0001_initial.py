...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CommentDetails'
        db.create_table(u'app_commentdetails', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('comment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Comment'])),
            ('posted_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.jUser'], null=True)),
        ))
        db.send_create_signal(u'app', ['CommentDetails'])

        # Adding M2M table for field upvoted_by on 'CommentDetails'
        m2m_table_name = db.shorten_name(u'app_commentdetails_upvoted_by')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('commentdetails', models.ForeignKey(orm[u'app.commentdetails'], null=False)),
            ('juser', models.ForeignKey(orm[u'app.juser'], null=False))
        ))
        db.create_unique(m2m_table_name, ['commentdetails_id', 'juser_id'])

        # Adding M2M table for field downvoted_by on 'CommentDetails'
        m2m_table_name = db.shorten_name(u'app_commentdetails_downvoted_by')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('commentdetails', models.ForeignKey(orm[u'app.commentdetails'], null=False)),
            ('juser', models.ForeignKey(orm[u'app.juser'], null=False))
        ...
        # Adding model 'TimelineCache'
        db.create_table(u'app_timelinecache', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cached_html', self.gf('django.db.models.fields.CharField')(max_length=2000000)),
            ('should_change_mark', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'app', ['TimelineCache'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CommentDetails'
        db.delete_table(u'app_commentdetails')

        # Removing M2M table for field upvoted_by on 'CommentDetails'
        db.delete_table(db.shorten_name(u'app_commentdetails_upvoted_by'))

        # Removing M2M table for field downvoted_by on 'CommentDetails'
        db.delete_table(db.shorten_name(u'app_commentdetails_downvoted_by'))

        # Deleting model 'TimelineCache'
        db.delete_table(u'app_timelinecache')
